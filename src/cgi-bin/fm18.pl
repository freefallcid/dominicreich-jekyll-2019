...
@referers = ('dominicreich.com','188.40.218.82','2a01:4f8:d0a:6449::2','localhost');
...
sub send_mail {
    ...
    print MAIL "X-Attribution: Dominic Reich\n";

    # Check for Message Subject
    #if ($Config{'subject'}) { print MAIL "Subject: [noblock] $Config{'subject'}\n\n" }
    #else                    { print MAIL "Subject: [noblock] WWW Form Submission\n\n" }
    print MAIL "Subject: [noblock] Kontaktformular\n\n";
